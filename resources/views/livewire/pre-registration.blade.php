        ...
        <div class="max-w-5xl w-full space-y-8">
            <div class="bg-white shadow-md rounded-lg p-6">
                <div class="flex justify-between items-center mb-6 mt-5">
                    ...
                    {{-- <input type="text" wire:model.live="search" placeholder="Search..." class="mt-1 p-2 block w-1/3 shadow-sm sm:text-sm border-gray-300 rounded-md"> --}}
                </div>
                ...
                <div class="mt-2">
                    <form wire:submit.prevent="register">
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            <button type="submit"
                                class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:ml-3 sm:w-auto sm:text-sm">Save
                                Changes</button>
                            <button type="button" wire:click="clear"
                                class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:w-auto sm:text-sm">Clear</button>
                        </div>
                    </form>
                </div>
                ...
                <div class="flex justify-between items-center mb-6 mt-5">
                    ...
                    <input type="text" wire:model.live="search" placeholder="Search..."
                        class="mt-1 p-2 block w-1/3 shadow-sm sm:text-sm border-gray-300 rounded-md">
                </div>
                ...
                <table class="min-w-full bg-white">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="3"
                                    class="py-2 px-4 border-b border-gray-300 text-sm text-gray-700 text-center">
                                    No records found
                                </td>
                            </tr>
                        @endforelse
